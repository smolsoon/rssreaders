...
namespace RssParser.RssParserModel
{
    public class RssParser
    {


        public static IEnumerable<Item> ParseRss(string url)
        {
        ...
        protected static IEnumerable<Item> atomToFeed(XmlNode xmlNode, XmlNamespaceManager nmmgr)
        {
            return getAtomChannels(xmlNode, nmmgr).SelectMany(x => x.Items);
        }
        ...
        protected static IEnumerable<Item> rssToFeed(XmlNode xmlNode)
        {
            return getRssChannels(xmlNode.SelectNodes("channel")).SelectMany(x => x.Items);
        ...
        protected static IEnumerable<Channel> getRssChannels(XmlNodeList xmlNodeList)
        {
            var channels = new List<Channel>();
